...
lookup_table_t lookup_table[NUMBER_KNOWN_KEYCODE] = {{"M0", QK_MACRO_0}, //_QK_MACRO
                                                     {"M1", QK_MACRO_1},
                                                     {"M2", QK_MACRO_2},
                                                     {"M3", QK_MACRO_3},
                                                     {"M4", QK_MACRO_4},
                                                     ...
                                                     {"RMeta", KC_RGUI},
                                                     {"Ms " CB_ICON_UP, MS_UP},
                                                     {"Ms " CB_ICON_DOWN, MS_DOWN},
                                                     {"Ms " CB_ICON_LEFT, MS_LEFT},
                                                     {"Ms " CB_ICON_RIGHT, MS_RGHT},
                                                     {"MsB1", MS_BTN1},
                                                     {"MsB2", MS_BTN2},
                                                     {"MsB3", MS_BTN3},
                                                     {"MsB4", MS_BTN4},
                                                     {"MsB5", MS_BTN5},
                                                     {"Whl" CB_ICON_UP, MS_WHLU},
                                                     {"Whl" CB_ICON_DOWN, MS_WHLD},
                                                     {"Whl" CB_ICON_LEFT, MS_WHLL},
                                                     {"Whl" CB_ICON_RIGHT, MS_WHLR},
                                                     {"Accel0", MS_ACL0},
                                                     {"Accel1", MS_ACL1},
                                                     {"Accel2", MS_ACL2},
                                                     {"!", KC_EXLM},
